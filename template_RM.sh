...
GENOME=<NAME>
RUNTYPE=${GENOME}_RM 
DIR=/lustre/scratch/daray/saliogen/extractions/$GENOME/$RUNTYPE 
LIBRARYPATH=/lustre/scratch/daray/saliogen/extractions/$GENOME/${GENOME}_DNA_library.fa 
GENOMEPATH=/lustre/scratch/daray/saliogen/assemblies 

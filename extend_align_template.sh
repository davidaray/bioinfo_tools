...
#### USAGE and OUTPUT
#
# Replace <NAME> in line 4 with your chosen job ID.
#
...
conda activate extend_env
module load load gcc/9.2.0 bedtools2/2.29.2 perl ncbi-rmblastn/2.9.0
...
for FILE in $THISGENOME/extract_align/catTEfiles/*.fa
	...
	if test $COUNT -gt 9 && test $LENGTH -gt 600; then cp $TEID"_rep.fa" $SD; fi 	

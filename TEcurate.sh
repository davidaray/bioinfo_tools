...
##### To do:
# 1. Incorpote information from self-blast.pairs.txt files generated by TE-Aid. These indicate the dot plots and 
#     should be useful in defining repeat units.  We'd want to examine this and take the appropriate single unit.

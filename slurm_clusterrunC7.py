...
REPEATMASKER = "/lustre/work/daray/software/RepeatMasker-4.1.0-centos7"
...
def buildDoLift(GENOME_NAME, OUTDIR):
	...
	OUT.write('/lustre/work/daray/software/RepeatMasker-4.1.0-centos7/util/buildSummary.pl -useAbsoluteGenomeSize -genome ' + GENOME_NAME + '.2bit ' + GENOME_NAME + '.fa.out > ' + GENOME_NAME + '.summary\n')
	OUT.write('gzip -f ' + GENOME_NAME + '.summary\n\n')
	OUT.write('# Generate RepeatLandscape\n')
	OUT.write('perl /lustre/work/daray/software/RepeatMasker-4.1.0-centos7/util/calcDivergenceFromAlign.pl -s ' + GENOME_NAME + '.divsum ' + GENOME_NAME + '.fa.align\n')
	OUT.write('perl /lustre/work/daray/software/RepeatMasker-4.1.0-centos7/util/createRepeatLandscape.pl -div ' + GENOME_NAME + '.divsum -twoBit ' + GENOME_NAME + '.2bit > ' + GENOME_NAME + '-landscape.html\n')
	...
	OUT.write('#then /lustre/work/daray/software/RepeatMasker-4.1.0-centos7/util/rmToUCSCTables.pl -out ' + GENOME_NAME + '.fa.out -align ' + GENOME_NAME + '.fa.align\n')
	OUT.write('#fi\n')
